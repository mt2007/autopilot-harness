...
- [ ] docs-cli-workspace-tip — doctor/docs：Antigravity CLI 须挂项目 workspace（如 `--add-dir`），否则 hooks 可能不加载
- [ ] tests-bundle-green — port 单测 + antigravity-contract + docs-contract；`pnpm bundle-vendor`；`pnpm test` + typecheck
