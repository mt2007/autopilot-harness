...
Default `.autopilot/config.yml` is generated by the CLI (`init`), not the templates package. Important review keys: `locale`, `review.confirm_rounds` (5 or light `3`), `review.verify.enabled` / `commands`, `review.stuck.max_idle_stops`.
