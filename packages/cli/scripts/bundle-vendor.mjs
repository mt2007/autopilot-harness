 ...
 * port-copilot-cli + port-grok-build + port-gemini-cli + port-factory-droid into
 * assets/vendor/runtime.mjs for project hooks. Also copies migration SQL beside
...
await esbuild.build({
  ...
  alias: {
    ...
    "@autopilot-harness/port-kimi-code": path.join(
      repoRoot,
      "packages",
      "ports",
      "kimi-code",
    ...
    "@autopilot-harness/port-grok-build": path.join(
      repoRoot,
      "packages",
      "ports",
      "grok-build",
    ...
    "@autopilot-harness/port-factory-droid": path.join(
      repoRoot,
      "packages",
      "ports",
      "factory-droid",
